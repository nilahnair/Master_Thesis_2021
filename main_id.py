...
ex= Experiment('Exp11 avg Type1 imu_norm clean lr0 batch50 epochs50')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
   ...
   #division_epochs = {'mocap': 2, 'mbientlab': 1, 'motionminers_flw': 1}
    ...
    batch_size_train = {
        ...
        'cnn_imu': {'mocap': 100, 'mbientlab':50, 'motionminers_flw': 100}}
...
##################################Check this again###############################################
    ...
    if usage_modus[usage_modus_idx] == 'train':
        ...
        '''
        folder_exp = folder_base + 'experiment11/'
        print(folder_exp)
        '''
