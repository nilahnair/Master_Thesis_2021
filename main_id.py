...
ex= Experiment('Exp24 Type2 mocap norm clean downsampled lr0 batch100')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
   ...
   #division_epochs = {'mocap': 2, 'mbientlab': 1, 'motionminers_flw': 1}
    ...
    if output[output_idx] == 'softmax':
        ...
        folder_base = "/data/nnair/output/avg/"
...
##################################Check this again###############################################
    ...
    if usage_modus[usage_modus_idx] == 'train':
        ...
        '''
        folder_exp = folder_base + 'experiment24/'
        print(folder_exp)
        '''
...
################################################################################################################################3
    ...
    dataset_root = {'mocap': '/data/nnair/output/type2/mocap/downsampled/',
