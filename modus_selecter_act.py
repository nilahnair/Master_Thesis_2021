...
class Modus_Selecter(object):
    ...
    def train(self, itera=1, testing=False):
        ...
        for iter_evl in range(itera):
            ...
            self.exp.log_scalar("standing_class_pos_val_final{}".format(iter_evl), c_pos_val[0])
            self.exp.log_scalar("walking_class_pos_val_final{}".format(iter_evl), c_pos_val[1])
            self.exp.log_scalar("cart_class_pos_val_final{}".format(iter_evl), c_pos_val[2])
            self.exp.log_scalar("handling_up_class_pos_val_final{}".format(iter_evl), c_pos_val[3])
            self.exp.log_scalar("handling_cen_class_pos_val_final{}".format(iter_evl), c_pos_val[4])
            self.exp.log_scalar("handling_down_class_pos_val_final{}".format(iter_evl), c_pos_val[5])
            self.exp.log_scalar("synch_class_pos_val_final{}".format(iter_evl), c_pos_val[6])
            self.exp.log_scalar("none_class_pos_val_final{}".format(iter_evl), c_pos_val[7])
            
            self.exp.log_scalar("standing_class_neg_val_final{}".format(iter_evl), c_neg_val[0])
            self.exp.log_scalar("walking_class_neg_val_final{}".format(iter_evl), c_neg_val[1])
            self.exp.log_scalar("cart_class_neg_val_final{}".format(iter_evl), c_neg_val[2])
            self.exp.log_scalar("handling_up_class_neg_val_final{}".format(iter_evl), c_neg_val[3])
            self.exp.log_scalar("handling_cen_class_neg_val_final{}".format(iter_evl), c_neg_val[4])
            self.exp.log_scalar("handling_down_class_neg_val_final{}".format(iter_evl), c_neg_val[5])
            self.exp.log_scalar("synch_class_neg_val_final{}".format(iter_evl), c_neg_val[6])
            self.exp.log_scalar("none_class_neg_val_final{}".format(iter_evl), c_neg_val[7])
        ...
        if testing:
            ...
            self.exp.log_scalar("standing_class_pos_test{}".format(iter_evl), count_pos_test[0])
            self.exp.log_scalar("walking_class_pos_test{}".format(iter_evl), count_pos_test[1])
            self.exp.log_scalar("cart_class_pos_test{}".format(iter_evl), count_pos_test[2])
            self.exp.log_scalar("handling_up_class_pos_test{}".format(iter_evl), count_pos_test[3])
            self.exp.log_scalar("handling_cen_class_pos_test{}".format(iter_evl), count_pos_test[4])
            self.exp.log_scalar("handling_down_class_pos_test{}".format(iter_evl), count_pos_test[5])
            self.exp.log_scalar("synch_class_pos_test{}".format(iter_evl), count_pos_test[6])
            self.exp.log_scalar("none_class_pos_test{}".format(iter_evl), count_pos_test[7])
            
            self.exp.log_scalar("standing_class_neg_test{}".format(iter_evl), count_neg_test[0])
            self.exp.log_scalar("walking_class_neg_test{}".format(iter_evl), count_neg_test[1])
            self.exp.log_scalar("cart_class_neg_test{}".format(iter_evl), count_neg_test[2])
            self.exp.log_scalar("handling_up_class_neg_test{}".format(iter_evl), count_neg_test[3])
            self.exp.log_scalar("handling_cen_class_neg_test{}".format(iter_evl), count_neg_test[4])
            self.exp.log_scalar("handling_down_class_neg_test{}".format(iter_evl), count_neg_test[5])
            self.exp.log_scalar("synch_class_neg_test{}".format(iter_evl), count_neg_test[6])
            self.exp.log_scalar("none_class_neg_test{}".format(iter_evl), count_neg_test[7])
