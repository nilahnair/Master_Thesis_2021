...
ex= Experiment('momin attr rep type 1 no4 euclidean 11')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    #all
    num_tr_inputs = {'mocap': 172561, 'mbientlab': 128263, 'motionminers_flw': 153683, 'pamap':90280}
...
################################################################################################################################3
    ...
    dataset_root = {'mocap': '/data/nnair/output/attributes/no7/mocap/input/',
                    ...
                    'motionminers_flw': '/data/nnair/momin/attr/no4/'}    
    '''
