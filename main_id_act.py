...
ex= Experiment('lara imu attr rep type 1 no5 bceloss 11')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    #all
    num_tr_inputs = {'mocap': 172561, 'mbientlab': 138732, 'motionminers_flw': 139222, 'pamap':90280}
   ...
   #division_epochs = {'mocap': 2, 'mbientlab': 1, 'motionminers_flw': 1}
    ...
    if output[output_idx] == 'softmax':
        ...
        folder_base = "/data/nnair/momin/attr/output/exp11/"
...
################################################################################################################################3
    ...
    dataset_root = {'mocap': '/data/nnair/output/attributes/no7/mocap/input/',
                    'mbientlab': '/data/nnair/lara/attr/no5/imu/input/',
