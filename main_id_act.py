...
ex= Experiment('mbient attr rep no3 euclidean')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    #all
    num_tr_inputs = {'mocap': 172561, 'mbientlab': 137512, 'motionminers_flw': 161667, 'pamap':90280}
...
################################################################################################################################3
    ...
    dataset_root = {'mocap': '/data/nnair/output/attributes/no7/mocap/input/',
                    'mbientlab': '/data/nnair/lara/attr/no3/imu/input/',
