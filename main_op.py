...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    num_classes = {'locomotion' : 4, 'gesture' : 4, 'pamap2' : 8, 'orderpicking': 5}
    ...
    num_tr_inputs = {'locomotion': 34162, 'gesture': 34162, 'pamap2': 103270, 'orderpicking': 92232}
    #input400
   ...
   #division_epochs = {'mocap': 2, 'mbientlab': 1, 'motionminers_flw': 1}
    ...
    batch_size_train = {
        ...
        'cnn_imu': {'locomotion': 100, 'gesture':50, 'pamap2': 50, 'orderpicking' : 200}}
