...
import platform
from modus_selecter_lstm import Modus_Selecter
...
ex= Experiment('lstm mocap type3 avg batch 100 lr0')
...
################################################################################################################################3
    ...
    dataset_root = {'mocap': '/data/nnair/output/activities/type3/mocap/',
