...
ex= Experiment('5 right handed people')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    division_epochs = {'mocap': 1, 'mbientlab': 1, 'virtual': 1, 'mocap_half': 1, 'virtual_quarter': 1,
    ...
    # Batch size
    batch_size_train = {
        'cnn': {'mocap': 25, 'mbientlab': 100, 'virtual': 100, 'mocap_half': 100, 'virtual_quarter': 100,
    ...
    batch_size_val = {'cnn': {'mocap': 25, 'mbientlab': 100, 'virtual': 100, 'mocap_half': 100,
    ...
    if output[output_idx] == 'softmax':
        labeltype = "class"
        folder_base = "/data/nnair/chris/hand/result/"
